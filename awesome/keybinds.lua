...
M.globalkeys = gears.table.join(
  awful.key({ modkey }, "d", function() awful.spawn(config.launcher) end,
    { description = "open an app launcher", group = "launcher" }),
...
M.clientkeys = gears.table.join(
  ...
  awful.key({ modkey, "Shift" }, "h", function(c) c:move_to_screen(c.screen:get_next_in_direction("left")) end,
    { description = "move to screen on the left", group = "client" }),
  awful.key({ modkey, "Shift" }, "l", function(c) c:move_to_screen(c.screen:get_next_in_direction("right")) end,
